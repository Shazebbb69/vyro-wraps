        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground max-w-sm mt-4">
              Premium self-applying lifting straps designed for maximum support,
              enhanced grip, and built to last.
            </p>

            <div className="flex space-x-4 pt-4 text-sm font-bold">
              <Link
  href="https://www.instagram.com/vyrowraps/"
  target="_blank"
...
>
  Instagram
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-xl font-heading tracking-wider mb-6 text-foreground uppercase">
              Quick Links
            </h4>
